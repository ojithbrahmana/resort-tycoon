...
export const CATALOG: BuildingCatalogItem[] = [
  ...
  },
  {
    ...
    requiresPower: false,
    incomePerSec: 4,
    modelPath: "/models/reception.final.glb",
    spritePath: "/sprites/reception.png",
    iconPath: "/sprites/reception.png",
    unlockLevel: 1,
    buildingTier: 1,
    description: "Welcomes guests and jumpstarts your resort.",
  },
]
